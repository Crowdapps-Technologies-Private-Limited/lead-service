...
import { validateAddSurveyTab2Payload } from '../validator';
import { addSurveyTab2 } from '../services';
...
export const addSurveyTab2Handler: RouteHandler = async (
    ...
    try {
        ...
        // Validate payload
        try {
            await validateAddSurveyTab2Payload(payload);
        } catch (error: any) {
        ...
        const result = await addSurveyTab2(leadId, payload, tenant);
