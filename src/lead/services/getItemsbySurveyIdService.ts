import {
    CHECK_TABLE_EXISTS,
    GET_SURVEY_BY_ID,
    GET_SURVEY_ITEMS_BY_SURVEY_ID,
} from '../../sql/sqlScript';
import { connectToDatabase } from '../../utils/database';
import logger from '../../utils/logger';
import { AddSurveyTab2Payload } from '../interface';

export const getSurveyedItems = async (leadId: string, surveyId: string, tenant: any) => {
    ...
    try {
       ...
       // Check if leads table exists
        ...
        const res = await client.query(GET_SURVEY_ITEMS_BY_SURVEY_ID, [surveyId]);
